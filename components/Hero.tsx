  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[linear-gradient(transparent_0%,rgba(6,182,212,0.1)_50%,transparent_100%)] bg-[size:100%_200%] animate-scan pointer-events-none" />
      </div>
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
         ...
         <div className="absolute top-8 left-8 flex flex-col gap-1">
            <div className="text-[10px] text-cyan-500 font-mono tracking-widest">SYS.STATUS: <span className="text-emerald-500 animate-pulse">OPTIMIZED</span></div>
            <div className="w-32 h-px bg-cyan-900/50"></div>
            <div className="text-[10px] text-slate-600 font-mono">ID: BARRIOS-A2I</div>
         </div>
         {/* Top Right */}
         <div className="absolute top-8 right-8 text-right">
            <div className="text-[10px] text-cyan-500 font-mono tracking-widest">NET.LATENCY: 12ms</div>
            <div className="flex gap-1 justify-end mt-1">
               <span className="w-1 h-1 bg-cyan-500 rounded-full"></span>
               <span className="w-1 h-1 bg-cyan-500 rounded-full opacity-50"></span>
               <span className="w-1 h-1 bg-cyan-500 rounded-full opacity-25"></span>
            </div>
         </div>
         {/* Bottom Left Crosshair */}
         <div className="absolute bottom-8 left-8 w-12 h-12 border-l border-b border-cyan-500/30"></div>
         {/* Bottom Right Crosshair */}
         <div className="absolute bottom-8 right-8 w-12 h-12 border-r border-b border-cyan-500/30"></div>
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        >
          ...
          <div className="relative p-8 md:p-12 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-2xl">
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-br from-cyan-500/20 to-transparent rounded-2xl opacity-50 blur-sm -z-10"></div>

            <h1 className="text-5xl md:text-7xl font-black text-white leading-[0.9] tracking-tighter mb-6">
              THE INFRASTRUCTURE OF A <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-cyan-400">$10M COMPANY.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <button className="group relative px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white font-bold tracking-widest uppercase text-sm transition-all hover:scale-105 shadow-[0_0_30px_rgba(6,182,212,0.4)]">
                Deploy Command Deck
                <div className="absolute inset-0 border border-white/20"></div>
              </button>

              <button className="group px-8 py-4 bg-transparent border border-slate-600 text-slate-300 font-bold tracking-widest uppercase text-sm hover:border-cyan-500 hover:text-cyan-400 transition-all">
                View Architecture
              </button>
            </div>
          </div>
        ...
        >
           <div className="relative w-full aspect-square max-w-md">
              ...
              <div className="absolute inset-8 border border-dashed border-cyan-500/30 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                 ...
                 <div className="text-xs text-cyan-500 uppercase tracking-widest bg-cyan-900/20 px-2 py-1 rounded border border-cyan-500/30">
                    Operational
                 </div>
              </div>
           </div>
